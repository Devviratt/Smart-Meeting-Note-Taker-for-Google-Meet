...
1. Create a new repository on GitHub by going to [GitHub](https://github.com/) and clicking on **New**.
...
5. Add the remote repository URL:
   ...
   ```bash
   git remote add origin https://github.com/yourusername/Smart-Meeting-Note-Taker.git
   ```
